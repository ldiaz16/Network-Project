...
flowchart LR
    ...
    DataStore -->|"OpenFlights + BTS files"| DataDir["data/"]
...
- **Data access**: `src/load_data.py` loads OpenFlights core files and optional BTS rollups, applies equipment/codeshare overrides, and exposes scoring helpers.
